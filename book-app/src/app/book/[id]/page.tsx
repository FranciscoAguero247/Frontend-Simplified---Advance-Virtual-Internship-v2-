  ...
  return (
    <div id="__next">
      <div className="wrapper">
        ...
        <div className="row">
          {book && <audio src={book.audioLink}></audio>}
                ...
                <div className="inner__wrapper">
                  <div className="inner__book">
                    ...
                    <div className="inner-book__read--btn-wrapper">
                      <button className="inner-book__read--btn" onClick={() => checkAccessAndNavigate(book)}>
                    ...
                    >
                      <div className="inner-book__bookmark--icon">
                        {isBookSaved ? (
                          ...
                          <svg stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 16 16" height="1em" width="1em">
